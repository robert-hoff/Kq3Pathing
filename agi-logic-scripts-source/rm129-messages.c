// [Messages for room 129 -- near desert

#message  1
"The soft, loamy soil of the forest here gives way to the sands of the
...
#message  3
"The trees here cast a refreshing shade."
...
#message  11
"None of these trees are suitable for climbing."
