...
<Layout version="1.6.1">
  ...
  <VerticalHeight>551</VerticalHeight>
  ...
  <Components>
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>Z:\git\kq3-hacking\asl-and-livesplit-scripts\KQ3-autosplitter-ECE-r4319_(only)-autostart-on-reset.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="begin-on-reset" type="bool">True</Setting>
          <Setting id="split-on-eagle-spell" type="bool">True</Setting>
          <Setting id="split-on-wizard-death" type="bool">True</Setting>
          <Setting id="split-on-reaching-island" type="bool">True</Setting>
          <Setting id="split-on-game-complete" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
    <Component>
