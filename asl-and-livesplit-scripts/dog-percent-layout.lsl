...
<Layout version="1.6.1">
  ...
  <Components>
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>Z:\git\kq3-hacking\asl-and-livesplit-scripts\KQ3-dog-percent-Dosbox-ECE-r4319.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="begin-on-reset" type="bool">True</Setting>
          <Setting id="split-on-getting-map" type="bool">True</Setting>
          <Setting id="split-on-starting-the-mountain" type="bool">True</Setting>
          <Setting id="split-on-finishing-mountain" type="bool">True</Setting>
          <Setting id="split-on-dog-pet" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
    <Component>
