...
<Layout version="1.6.1">
  ...
  <Components>
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>Z:\git\kq3-hacking\asl-and-livesplit-scripts\dog-percent-practise-autosplitter2.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="startonfirstmove" type="bool">True</Setting>
          <Setting id="split-on-map-arrive" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
    <Component>
